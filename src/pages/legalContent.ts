export const legalPages = {
  ...
  '/datenschutz': {
    ...
    sections: [
      ...
      { heading: 'Speicherung', body: 'Unterlagen werden im Ordner datenbasis/ gespeichert. Stammdaten, gespeicherte Anschreiben, Einstellungen und API-Keys werden in der lokalen SQLite-Datenbank data/app.db gespeichert. Die Daten bleiben auf dem Server, auf dem die App installiert ist.' },
      { heading: 'API-Keys', body: 'API-Keys werden zentral gespeichert, damit die App im lokalen Netzwerk von mehreren Geräten genutzt werden kann. Der Schlüssel wird im Frontend nicht im Klartext angezeigt. Jeder Betreiber sollte den Server, die Datenbankdatei und Backups gegen unbefugten Zugriff schützen.' },
      { heading: 'Backups', body: 'Backups können Stammdaten, Unterlagen, gespeicherte Anschreiben, Einstellungen und API-Keys enthalten. Backup-Dateien sollten deshalb vertraulich gespeichert, verschlüsselt abgelegt oder nach Nutzung gelöscht werden.' },
      ...
      { heading: 'Sicherheit', body: 'Der Betrieb ist für ein vertrauenswürdiges lokales Netzwerk vorgesehen. Für produktive Installationen sollten Zugriffsschutz, sichere Backups, aktuelle Systemupdates und eine geeignete Absicherung des Servers eingerichtet werden.' },
